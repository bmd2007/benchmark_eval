...
def MoranAC(fastas, aaIDs = ['GUO_H1','HOPT810101','KRIW790103','GRAR740102','CHAM820101','ROSG850103_GUO_SASA','GUO_NCI'], lag=30, deviceType='cpu'):
	return Covariance(fastas,aaIDs,lag,separate=False,calcType='Moran',deviceType=deviceType)