...
#aaIndexParameters.append('GUO_SASA') #solvent-accessible surface area (SASA)  Added Guo's Values to AAIndex, taken from Rose et.al 1985, from same table that provides ROSG850101 and ROSG850101, but Guo uses standard state surface area instead
#aaIndexParameters.append('GUO_NCI') #net charge index (NCI) of side chains of amino acid	Cannot find paper these came from


def NMBrotoAC(fastas, aaIDs = ['GUO_H1','HOPT810101','KRIW790103','GRAR740102','CHAM820101','ROSG850103_GUO_SASA','GUO_NCI'], lag=30, deviceType='cpu'):
	return Covariance(fastas,aaIDs,lag,separate=False,calcType='NMBroto',deviceType=deviceType)